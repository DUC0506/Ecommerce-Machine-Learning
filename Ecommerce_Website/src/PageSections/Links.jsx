...
import {  getProductsByApartment } from '../api/products'
...
const Links = ({categorys , idCategory}) => {
  ...
  return (
    <div className='m-auto max-w-6xl mt-16'>
        ...
        <div className='flex m-auto max-w-4xl mt-10 mb-10 flex-wrap align-middle items-center justify-center w-full'>
...
{/* 
        ...
        <div className='flex justify-around mb-5 flex-wrap w-full'>
                ...
                <div className='flex w-full items-center justify-center my-4'>
                        <FaRegCaretSquareLeft onClick={()=>{handleLeftNum()}} className=' text-3xl text-yellow-400 cursor-pointer mr-4' />
                        ...
                        <FaRegCaretSquareRight onClick={()=>{handleRightNum()}} className=' text-3xl text-yellow-400 cursor-pointer ml-4' />
                </div>
        </div>
