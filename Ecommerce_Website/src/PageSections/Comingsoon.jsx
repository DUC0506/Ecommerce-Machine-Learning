    ...
    <div className="c-main1">
      <div className="c-main2">
        <div className="flex justify-between">
          <div className="leading-4 text-2xl">
            {" "}
            <span className="text-yellow-400">Site in Progress ...</span>🚧
          </div>
          <div
        ...
        <div className="w-full text-center mt-4">
          ...
          <div className="text-sm">
            {" "}
            Some Functions like Checkout, Delivery, Pickup <br></br>And Search
            Functionality Might not work
          </div>
        </div>
        <div className="absolute text-xs bottom-0 right-1 p-2">
          <span className="text-yellow-500">Contact</span>
          :oluwarimigbadebo@gmail.com
        </div>
      </div>
    </div>
  );
