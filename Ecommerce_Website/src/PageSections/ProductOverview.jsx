          ...
          <div class="grid grid-cols-1 lg:grid-cols-2">
            <div class="slider-box w-full h-full max-lg:mx-auto mx-0">
              ...
              <div class="nav-for-slider ">
                <div class="swiper-wrapper flex ">
                  <div class="swiper-slide thumbs-slide mr-2">
                    <img
            ...
            <div class="flex justify-center items-center">
              <div class="pro-detail w-full lg:max-w-[608px] lg:pl-8 xl:pl-16 lg:mx-auto lg:mt-4">
                ...
                <div class="flex  min-[400px]:flex-row min-[400px]:items-center mb-8 gap-y-3">
                ...
                <div class="flex items-center flex-col min-[400px]:flex-row gap-3 mb-3 min-[400px]:mb-8">
                  ...
                  <button class="group py-3 px-5 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-lg w-full flex items-center justify-center gap-2 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-indigo-300 hover:bg-indigo-100">
                    <svg
