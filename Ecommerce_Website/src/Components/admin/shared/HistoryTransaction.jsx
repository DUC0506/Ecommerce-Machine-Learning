            ...
            <option className='font-sans  ' >Đã vận chuyển</option>           
              ...
              <div className="w-full">
				...
				<div className="flex bg-gray-200 mb-2 ">
					<div className="w-1/4 py-2 px-4 font-sans font-medium  items-center flex ">Tình trạng</div>
					<div className="w-1/6 py-2 px-4 font-sans font-medium   items-center flex">Số lượng </div>
					<div className="w-1/6 py-2 px-4 font-sans font-medium justify-center items-center flex"> Phương thức thanh toán</div>
					<div className="w-1/6 py-2 px-4 font-sans font-medium justify-center  items-center flex">Thanh toán</div>
          <div className="w-1/6 py-2 px-4 font-sans font-medium justify-center items-center flex">Vận chuyển</div>
          <div className="w-1/6 py-2 px-4 font-sans font-medium justify-center items-center flex">Địa chỉ</div>
          <div className="w-1/6 py-2 px-4 font-sans font-medium justify-center  items-center flex">Tổng hóa đơn</div>
				...
				{orders.map((order, index) => (
					<div key={order._id} className={`flex rounded bg-white ${index !== 0 ? 'mt-2' : ''}`}>
						...
						<div className="w-1/6  font-sans font-medium justify-center flex items-center  p-4">{order.isPaid ?'Đã thanh toán':'Chưa thanh toán'} </div>
            <div className="w-1/6  font-sans font-medium justify-center flex items-center  p-4">{order.isDelivered ?'Đã vận chuyển':'Chưa vận chuyển'} </div>
						<div className="w-1/6  font-sans font-medium justify-center flex items-center  p-4">{order.shippingAddress.address +' '+ order.shippingAddress.city} </div>
