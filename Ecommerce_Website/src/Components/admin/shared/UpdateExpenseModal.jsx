...
export default function UpdateExpenseModal({ expense, onClose }) {
    ...
    <div className="fixed inset-0 flex items-center justify-center w-full bg-gray-500 bg-opacity-50">
      <div className="bg-white p-4 rounded w-1/2">
        ...
        <p class="text-base font-normal text-gray-500 lg:text-lg mb-4">
          Here you can edit or view detailed expense on the platform
        </p>
        ...
        <div className="flex">
          ...
          <div class="relative w-1/2 ml-2 mt-4">
            <input
              type="text"
              id="typeExpense"
              name="createdAt"
              value={convertISOToDateFormat(expense.createdAt)}
              onChange={handleEditExpense}
              class="block px-2.5 pb-2.5 pt-4 w-full font-sans text-sm text-gray-900 bg-transparent rounded-lg border-2 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-yellow-400 focus:ring-0 focus:border-yellow-500 peer"
              placeholder=" "
            />
      ...
      /> */}
        ...
        <div className="flex justify-end">
          <button className="bg-yellow-500 flex items-center hover:bg-yellow-600 text-white font-semibold font-sans py-2 px-4 rounded mr-2">
