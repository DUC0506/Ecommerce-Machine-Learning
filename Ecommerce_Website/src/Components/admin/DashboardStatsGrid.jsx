	...
	return (
		<div className="flex gap-4">
			<BoxWrapper >
				...
				<div className="pl-4 cursor-pointer">
					...
					<div className="flex items-center cursor-pointer">
						<strong className="text-xl text-gray-700 font-semibold font-sans">{totalSales}</strong>
			...
			<BoxWrapper>
				...
				<div className="pl-4 cursor-pointer">
					<span className="text-sm text-gray-500  font-sans font-normal">Total Apartment</span>
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold font-sans">{apartments}</strong>
						<span className="text-xl text-yellow-500 pl-2"><MdApartment /></span>
					</div>
				</div>
			</BoxWrapper>
			<BoxWrapper>
				...
				<div className="pl-4 cursor-pointer">
					<span className="text-sm text-gray-500 font-normal font-sans">Total Seller</span>
					<div className="flex items-center">
