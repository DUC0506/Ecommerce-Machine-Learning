  ...
  return (
    <div div className="w-full ">
      ...
      >
        ...
        <p className="mt-2 w-full font-sans " readOnly>
          {content}
        </p>

        <div
          className="absolute top-2 right-2 m-2 cursor-pointer "
              ...
              {isManagement ? (
                <>
                  {isApproved ? (
                    <button
                      onClick={() =>
                        handleUpdateApproval(id, { isApproved: false })
                      }
                      className=" flex items-center px-4 py-2 text-gray-700  rounded-t hover:bg-yellow-200"
                    >
                      <TbNewsOff className="mr-1 text-xl" /> Disapprove
                    </button>
                  ) : (
                    <button
                      onClick={() =>
                        handleUpdateApproval(id, { isApproved: true })
                      }
                      className="flex items-center px-4 py-2 text-gray-700 rounded-t hover:bg-yellow-200"
                    >
                  ...
                  <button
                    ...
                    className="flex items-center px-4 py-2 text-red-700 w-full rounded-b hover:bg-yellow-200"
                  >
                ...
                <>
                  <button
                    ...
                    className="flex items-center px-4 py-2 w-full rounded-t text-gray-700 hover:bg-yellow-200"
                  >
                    <MdOutlineEditCalendar className="mr-1 text-xl" /> Edit
                  </button>
                  <button
                    onClick={() => handleRemovePost(id)}
                    className="flex items-center px-4 py-2 text-red-700 hover:bg-yellow-200"
                  >
                    <MdDelete className="mr-1 text-xl" /> Delete
                  </button>
                </>
