...
export const getDistance = catchAsync(async (req, res) => {
  ...
  let price;
  if (weightProduct <= 1) {
    price = expensesDistance * 100;
  } else if (weightProduct <= 20) {
    price = expensesDistance * 150;
  } else if (weightProduct <= 40) {
    price = expensesDistance * 200;
  } else {
    price = expensesDistance * 250;
  }
